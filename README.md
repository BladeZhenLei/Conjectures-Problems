...
<strong> Answer </strong>
<br/>
No. The first three counter examples appeared at $n=63$, $n=161$, and $n=382$ for $n\leq538$.
...
**8.**
A graph $G$ has degree sequence of all of elements as primes $\geq3$, i.e., $\lbrace{2,\cdots,2,3,\cdots,3,5,\cdots,5,\cdots}\rbrace$, where $\sum{deg(v_i)}=2|E(G)|$, then by handshaking lemma there are even numbers of odd primes. Since the number of verticies $v(G)$ will at least have the largest element $max|v_i|+1$, 
