***
### Main Conjectures
Many of these problems involving large number compuation is beyond the current compacity of conventional computers and even super computers. It can only be hoped that advances in additive number theory, or, quantum computation can help further understand such problems.
<p/>
